...
- 재료 추가\*
  - 재료 이름 중복검사를 진행한다.
  - 재료 데이터를 서버로 전송한 뒤 전달받은 결과를 출력한다.
- 나의 냉장고에 추가\*
  - 추가될 재료를 재료 이름으로 검색하여 선택한다.
  - 재료 이름 검색시 자동 완성 기능을 제공한다.
  - 이미지를 등록할 수 있다.
  - 보유한 재료 데이터를 서버로 전송한 뒤 전달받은 결과를 출력한다.

<!--
이부분 다시 기획하고 수정하기
- 나의 냉장고 목록\*
  - 나의 냉장고에 추가한 재료 목록을 출력한다.
- 나의 냉장고 상세\*
  - 나의 냉장고에 추가한 재료의 상세 정보와 사용 기록을 출력한다.
- 나의 냉장고 수정\*
  - 나의 냉장고에 있는 나의 재료를 수정한다.
- 나의 냉장고 기록 추가\*
- 나의 냉장고 기록 수정\*
-->
